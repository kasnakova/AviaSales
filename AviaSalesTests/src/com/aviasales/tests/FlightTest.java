...
public class FlightTest {
	...
	public void testToString() {
		...
		assert(f.toString().trim().equals(
				"Flight number: 99A3 Departure airport: LGW Arrive airport: DMD Departure time: 12.07.2016 12:15 Arrive time: 12.07.2016 14:15 Cost: 123.4"));
	...
	public void testIsConnectingFlight() {
		...
		assert(true == Analizator.isConnectingFlight(f, f1));
	}
	...
	public void testIsEndFlight() {
		...
		f.toString();
		SearchParams s = new SearchParams("LGW", "DMD", d.toLocalDate(), 3);

		System.out.println();
		assert(Analizator.isEndFlight(f, s.getArr()) == true);
	}
